#ifndef LEVEL_PARALLELOGRAM_2_H
#define LEVEL_PARALLELOGRAM_2_H
...
class Level_Parallelogram_2 final : public ILevel
{
public:
    explicit Level_Parallelogram_2(Matrix* matrix, GraphicView* view, GraphicScene* scene);
    ~Level_Parallelogram_2() = default;
