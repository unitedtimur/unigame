#ifndef LEVEL_LABIRINT_2_H
#define LEVEL_LABIRINT_2_H
...
class Level_Labirint_2 final : public ILevel
{
    Q_OBJECT

public:
    explicit Level_Labirint_2(Matrix* matrix, GraphicView* view, GraphicScene* scene);
    ~Level_Labirint_2() = default;
