#ifndef LEVEL_PARALLELOGRAM_1_H
#define LEVEL_PARALLELOGRAM_1_H
...
class Level_Parallelogram_1 final : public ILevel
{
public:
    explicit Level_Parallelogram_1(Matrix* matrix, GraphicView* view, GraphicScene* scene);
    ~Level_Parallelogram_1() = default;
