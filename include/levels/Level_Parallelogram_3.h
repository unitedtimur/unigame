#ifndef LEVEL_PARALLELOGRAM_3_H
#define LEVEL_PARALLELOGRAM_3_H
...
class Level_Parallelogram_3 final : public ILevel
{
public:
    explicit Level_Parallelogram_3(Matrix* matrix, GraphicView* view, GraphicScene* scene);
    ~Level_Parallelogram_3() = default;
